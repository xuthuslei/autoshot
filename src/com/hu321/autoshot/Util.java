...
public class Util {
     ...
     * @param params 请求的参�?
     * @return 返回的信�?
     * @throws MalformedURLException url地址格式异常时，抛出该异�?
     ...
     * @param ctype Content-Type的格�?
     * @return 返回HttpURLException
     * @throws MalformedURLException url格式异常时，抛出该异�?
